...
const openai = new OpenAI({
  ...
  baseURL: 'https://api.deepmyst.ai/v1'  // DeepMyst endpoint
});
...
```bash
curl https://api.deepmyst.ai/v1/chat/completions \
...
For additional help, visit our [Support Center](https://support.deepmyst.ai) or contact us at support@deepmyst.ai.
